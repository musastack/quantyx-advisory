            ...
            <div className="mb-14">
              ...
              <div className="grid md:grid-cols-[1fr_auto] items-end gap-6">
                ...
                <p className="text-slate-400 dark:text-white/40 text-sm">
                  Based on real engagements. Client names anonymised.
                </p>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="border-t border-slate-100 dark:border-white/[0.05] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs text-slate-400 dark:text-white/25">
              <a href="https://linkedin.com/company/quantyx-advisory" target="_blank" rel="noopener noreferrer"
              ...
              <a href="/privacy" className="hover:text-slate-700 dark:hover:text-white/50 transition-colors">Privacy Policy</a>
              <a href="/terms" className="hover:text-slate-700 dark:hover:text-white/50 transition-colors">Terms</a>
            </div>
          </div>
        </div>
      </footer>
